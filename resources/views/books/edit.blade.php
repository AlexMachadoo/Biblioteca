    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('books.update', $book->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editora" name="editora" value="{{ $book->editora }}" required>
            </div>
            <div class="mb-3">
                <label for="ano_publicacao" class="form-label">Ano de Publicação</label>
                <input type="text" class="form-control" id="ano_publicacao" name="ano_publicacao" value="{{ $book->ano_publicacao }}" required>
            </div>
